				...
				<div className="tf-page-cart-wrap">
					<div className="tf-page-cart-item">
						<form onSubmit={(e) => e.preventDefault()}>
										...
										<tr key={i} className="tf-cart-item file-delete">
											<td className="tf-cart-item_product">
												...
												<div className="cart-info">
													<Link
														href={`/product-detail/${elm.id}`}
														className="cart-title link mainfont"
													>
														{elm.title_web}
													</Link>
													{/* <div className="cart-meta-variant">White / M</div> */}
													<span
														className="remove-cart link remove mainfont"
											...
											>
												<div className="cart-price">
													{elm?.saleprice != 0
														? `${Number(elm?.saleprice).toFixed(2)}`
											...
											>
												...
												>
													...
													{elm?.saleprice !== 0
														? `${(
																Number(elm?.saleprice) * Number(elm?.quantity)
														  ).toFixed(2)} ₾`
														: `${(
																Number(elm?.price) * Number(elm?.quantity)
														  ).toFixed(2)} ₾`}
												</div>
											</td>
										</tr>
							...
							{!cartProducts.length && (
								<>
									<div className="row align-items-center mb-5 mainfont">
										<div className="col-6 fs-18">თქვენი კალათა ცარიელია</div>
										<div className="col-6">
											<Link
												href={`/`}
                  ...
                  <label htmlFor="cart-gift-checkbox" className="fw-4">
                    ...
                    <span className="fw-5">$5.00</span>
								...
								<div className="tf-cart-totals-discounts">
									<h3 className="mainfont">საერთო ჯამი</h3>
                  ...
                  <label htmlFor="check-agree" className="fw-4">
                    ...
                    <Link href={`/terms-conditions`}>terms and conditions</Link>
								...
								<div className="cart-checkout-btn">
									...
									>
										<span className="mainfont">ანგარიშსწორება</span>
									</Link>
								</div>
