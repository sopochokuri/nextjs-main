                  ...
                  <div className="tf-minicart-recommendations">
                    ...
                    <div className="tf-minicart-recommendations-title">
                      ...
                      {data?.size && (
                        <div className="tf-product-info-liveview">
                          <p className="fw-8 info-line">
                            ...
                            <span className="font-normal">{data?.size}</span>
                          </p>
                        </div>
                      )}
                      {data?.weight && (
                      ...
                      {data?.volume && (
                        <div className="tf-product-info-liveview">
                          <p className="fw-8 info-line">
                            ...
                            <span className="font-normal">{data?.volume}</span>
                          </p>
                        </div>
                      )}
                      ...
                      {data?.composition && (
                        <div className="tf-product-info-liveview">
                          <p className="fw-8 info-line">
                            <span className="label"> შემადგენლობა:</span>
                            <span className="font-normal">
                              {data?.composition}
                            </span>
                          </p>
                    ...
                    <div className="tf-minicart-recommendations-title description">
                      <p className="bold">პროდუქტის აღწერა</p>
                      <p>{data?.description}</p>
                    </div>
                    <div className="tf-minicart-recommendations-title instruction">
                      <p className="bold">მოხმარების ინსტრუქცია</p>
                      <p>{data.content}</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="tf-mini-cart-bottom">
                <div className="tf-mini-cart-bottom-wrap">
                  <div className="tf-cart-totals-discounts">
                    <div className="tf-cart-total mainfont">სულ გადასახადი</div>
